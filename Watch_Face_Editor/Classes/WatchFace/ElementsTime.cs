...
namespace Watch_Face_Editor
{
    ...
    /// <summary>Цифровое время (минуты)</summary>
    public class hmUI_widget_IMG_TIME_minute
    {
        /// <summary>Позиция в наборе элементов</summary>
        public int position = -1;
        ...
        /// <summary>X координата минут</summary>
        public int minute_startX { get; set; }

        /// <summary>Y координата минут</summary>
        ...
        /// <summary>Набор картинок для цифр</summary>
        public List<string> minute_array { get; set; }

        /// <summary>Разделитель</summary>
        public string minute_unit { get; set; }
    ...
    public class hmUI_widget_TEXT_TIME_minute
    {
        /// <summary>Позиция в наборе элементов</summary>
        public int position = -1;
